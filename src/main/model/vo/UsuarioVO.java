...
public class UsuarioVO {
    ...
    public UsuarioVO(int idUsuario, String nome, String sobrenome, Date dataNascimento, String usuarioEmail, int usuarioCep, String senha, int pontuacaoUsuario, String sexo) {
